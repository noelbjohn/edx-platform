...
def compose_calendar_sync_email_context(course: CourseOverview, update=False):
    ...
    if update:
        calendar_sync_subject = _('Updates for Your {} Schedule'.format(course_name))
        calendar_sync_headline = _('Update Your Calendar')
        calendar_sync_body = _('Your assignment due dates for {} were recently adjusted. Update your calendar with '
